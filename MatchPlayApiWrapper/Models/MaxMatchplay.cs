...
{
    /// <summary>
    /// Represents a Max Matchplay tournament and its details.
    /// </summary>
    public class MaxMatchplay
    {
        ...
        public MaxMatchplayOrganizer Organizer { get; set; }
        /// <summary>Gets or sets the location details.</summary>
        public MaxMatchplayLocation Location { get; set; }
    ...
    /// <summary>
    /// Represents the organizer of a Max Matchplay tournament.
    /// </summary>
    public class MaxMatchplayOrganizer
    {
